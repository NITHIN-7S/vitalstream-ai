...
const Footer = () => {
  // WhatsApp and Instagram icons as custom SVGs
  const WhatsAppIcon = () => (
  ...
  const socialLinks = [
    { 
      icon: WhatsAppIcon, 
      href: "https://api.whatsapp.com/send/?phone=%2B917893254003&text&type=phone_number&app_absent=0", 
      label: "WhatsApp" 
    },
    { 
      icon: InstagramIcon, 
      href: "https://www.instagram.com/health._.care._.108?igsh=cHp1cGRzdTJwaml2", 
      label: "Instagram" 
    },
  ];
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-3">
              ...
              <li>
                <a 
                  href="mailto:emergencypulsemonitoring@gmail.com" 
                  className="flex items-center gap-2 text-sm text-muted-foreground hover:text-primary transition-colors"
                >
                  <motion.div
